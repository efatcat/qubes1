...
class Player {
    ...
    drawShape(ctx, x, y, w, h, skin) {
        ...
        if (skin.id === 'sixseven') {
            ...
            // Нормальное лицо (чёрные глаза и рот)
            ctx.fillStyle = '#222';
        ...
        // Глаза и рот для всех остальных скинов
        ctx.fillStyle = '#222';
        ctx.fillRect(x + 10, y + 10, 8, 8);
        ctx.fillRect(x + 22, y + 10, 8, 8);
        ctx.fillRect(x + 10, y + 25, 20, 4);
